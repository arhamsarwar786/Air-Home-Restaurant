  ...
  Widget build(BuildContext context) {
    return Drawer(
      child: ListView(
        ...
        children: <Widget>[
          _createHeader(),
          _createDrawerItem(uri:"assets/images/left-arrow-black.png", text: Constants.AIR_CHEF_MENU_LABEL1,),
          Divider(),
          _createDrawerItem(uri:"", text: 'My AirChef Profile',),
          _createDrawerItem(uri:"assets/images/airchef.png", text: Constants.AIR_CHEF_MENU_LABEL2,),
          _createDrawerItem(uri:"assets/images/star.png", text: Constants.AIR_CHEF_MENU_LABEL3,),
                    ...
                    Container(
                      child: Padding(
                        ...
                        child: _myWidget.myText(
                            "First Name", 12.0, FontWeight.bold, 1, Colors.white),
                      ),
                    ),
                  ]),
              Expanded(
