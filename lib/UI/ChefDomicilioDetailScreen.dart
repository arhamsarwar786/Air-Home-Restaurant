...
class ChefDomicilioDetailScreen extends StatefulWidget {

  @override
  State<ChefDomicilioDetailScreen> createState() => _ChefDomicilioDetailScreenState();
}

class _ChefDomicilioDetailScreenState extends State<ChefDomicilioDetailScreen> {
      ...
      body: SingleChildScrollView(
        child: SafeArea(child: Container(
          child: Column(children: [
              ...
              child: Text("Chef at home",style: TextStyle(fontSize: 30,color: Colors.red),textAlign: TextAlign.start,)),
                                        ListView.builder(
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (_) => SinglePostShow("Chef at home","7")));
                    },child: Text("SEE ALL POST",style: TextStyle(color: Colors.white),),color: Colors.red,),
                                      ],
                                    );
              ...
              padding: EdgeInsets.all(8.0),
              alignment: Alignment.topLeft,
              child: Text("eRestaurant",style: TextStyle(fontSize: 30,color: Colors.red),textAlign: TextAlign.start,)),
                                        ListView.builder(
                                          physics: NeverScrollableScrollPhysics(),
                                          shrinkWrap: true,
                                          itemCount: (postLength >= categoryPosts.data.length) ? categoryPosts.data.length:postLength,
                                          ...
                                          itemBuilder: (context, position) {
                                            return InkWell(
                                             ...
                                             (postLength > originalLength) ? Container():       MaterialButton(onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (_) => SinglePostShow("eRestaurant","10")));
                    },child: Text("SEE ALL POST",style: TextStyle(color: Colors.white),),color: Colors.red,),
