...
class CorsoCusina3 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _CorsoCusina3();
}

class _CorsoCusina3 extends State<CorsoCusina3> {
  MyWidget _myWidget;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:
      _myWidget.myAppBar(Constants.CORSO_CUSINA3_ALLLEGIES_MODEL_TITLE, () {
                          ...
                          child: Padding(
                            ...
                            child: Align(
                              ...
                              child: _myWidget.myText(
                                  Constants.CORSO_CUSINA3_ALLLEGIES_MODEL_LABEL1,
                                  15.0,
                                  FontWeight.bold,
                                  1,
                                  Colors.black),
