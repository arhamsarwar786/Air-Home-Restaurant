...
class TourGastronomicDetailScreen extends StatefulWidget {
  @override
  State<TourGastronomicDetailScreen> createState() =>
      _TourGastronomicDetailScreenState();
}

class _TourGastronomicDetailScreenState
    extends State<TourGastronomicDetailScreen> {
  MyWidget _myWidget;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: _myWidget.myAppBar("Tour Gastronomic", () {
