...
class HomeRestaurant2 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _HomeRestaurant2();
}

class _HomeRestaurant2 extends State<HomeRestaurant2> {
  MyWidget _myWidget;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:
      _myWidget.myAppBar(Constants.HOME_RESTAURANT2_TITLE, () {
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                        height: 50.0,
                        width: 50.0,
                        child: Image.asset("assets/images/food-tray.png")),
                    Expanded(
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: _myWidget.myText(
                                  "Starter", 12, FontWeight.bold, 1, Colors.black),
                            ),
                          ),
                        )),
                  ],
