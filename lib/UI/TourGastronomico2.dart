...
class _TourGastronomico2 extends State<TourGastronomico2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: _myWidget.myAppBar(Constants.TOUR_GASTRONOMICO2_TITLE, () {
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(10.0),
                          child: _myWidget.myText("Suitable for children", 12,
                              FontWeight.bold, 1, Colors.black),
                        ),
                      ),
                    )),
              ...
              Padding(
                ...
                child: Container(
                    child: Text(
                  Constants.TOUR_GASTRONOMICO2_LABEL1,
                  ...
                  child: Center(
                    child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            Constants.TOUR_GASTRONOMICO2_BUTTON1,
                            textAlign: TextAlign.center,
                  ...
                  children: [
                    Container(
                      child: Align(
                        ...
                        child: _myWidget.myText(
                            Constants.TOUR_GASTRONOMICO2_LABEL2,
                            15.0,
                            FontWeight.bold,
                            1,
                            Colors.black),
